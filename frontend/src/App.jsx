...
const App = () => {
  ...
  const [data, setData] = useState({
    ...
    projectDescription: '',
    logo: '',
    companyName: 'SRP Creation',
    companyAddress: 'No-679, Lake Road, Borelasgamuwa',
    companyPhone: '0714418637',
    companyEmail: '',
    companyTagline: 'Media & Entertainment • Television • Equipment & Supplies',
    companyWebsite: '',
    currency: 'Rs.',
    items: [
      { id: 1, date: '', itemName: '', quantity: 1, price: 0 }
    ],
